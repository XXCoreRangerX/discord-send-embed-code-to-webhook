...
export default {
  config: {
    ...
    "webhook-footer-text": {
      ...
      "description": "Footer text of the embed message.",
      "type": "string",
    ...
    "webhook-footer-image": {
      ...
      "description": "Footer image of the embed message.",
      "type": "string",
      "default": "https://avatars.githubusercontent.com/u/1089146?s=200&v=4",
      "order": 10
    },
    "hastebin-url": {
      "title": "Hastebin URL",
      "description": "Hastebin server URL. Leave empty to disable.",
      "type": "string",
      "default": "",
      "order": 11
    }
  ...
  sendSelectionToDiscord() {
    ...
    if (editor = atom.workspace.getActiveTextEditor()) {
      const selection = editor.getSelectedText(), selectionHastebin = selection;
      if (selection) {
        ...
        if (properties.webhookURL) { // The user has set his webhook URL in the config
          if (selection.length > this.discordCharLimit) { // If content has more characters than discord char limit
            ...
            notification = atom.notifications.addWarning(
              "Your selection has more characters than discord's max limit (" + discordCharLimit + " characters)!", {
                dismissable: true,
                buttons: [{
                    onDidClick: function() {
                    ...
                    text: "Send only the first " + discordCharLimit + " characters"
                  },
                  {
                    onDidClick: function() {
                      notification.dismiss()
